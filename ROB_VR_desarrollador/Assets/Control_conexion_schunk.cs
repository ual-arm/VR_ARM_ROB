...
public class DropdownOptionManager_schunk : MonoBehaviour
{
    ...
    public TMP_DropdownManager_schunk dropdownManagerpuntos;
    public Control_trayectoria_schunk dropdownManagertrayectorias;
    public Comunicacion_schunk comunicacion_Irb140;

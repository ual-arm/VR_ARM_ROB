...
- Protocolos de comunicación que emplea Unity para los distintos robots, [IRB140]([Códigos de interes/](https://github.com/ual-arm/VR_ARM_ROB/blob/main/C%C3%B3digos%20de%20interes/IRB140/Comunicaci%C3%B3n/Comunicacion_irb140.cs)), [IRB1090](Códigos de interes/IRB1090/Comunicación/Comunicacion_irb1090.cs) y [SCHUNK](Códigos de interes/SCHUNK/Comunicación/Comunicacion_schunk.cs).

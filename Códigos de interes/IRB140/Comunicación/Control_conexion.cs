...
public class DropdownOptionManager : MonoBehaviour
{
    ...
    public TMP_DropdownManager dropdownManagerpuntos;
    public Control_trayectoria dropdownManagertrayectorias;

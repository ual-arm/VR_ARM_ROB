...
public class Control_trayectoria_irb1090 : MonoBehaviour
{
    ...
    private Comunicacion_irb1090 comunicacionesScript;
    ...
    private void Start()
    {
        ...
        comunicacionesScript = Comunicacion.GetComponent<Comunicacion_irb1090>();
    }
    ...
    public void MoverPunto()
    {
        ...
        {
            inicio = true;
            Comunicacion_irb1090 comunicacionIr140 = Comunicacion.GetComponent<Comunicacion_irb1090>();
    ...
    IEnumerator RotacionGradualTrayectorias(Quaternion[][] rotacionesDeseadas)
    {
        ...
        for (int j = 1; j < rotacionesDeseadas.Length; j++)
        {
            ...
            {
                distancia[j] = comunicacionesScript.distancia[j];

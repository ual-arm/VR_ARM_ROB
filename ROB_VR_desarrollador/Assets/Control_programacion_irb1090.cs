...
public class Control_programacion_irb1090 : MonoBehaviour
{
    ...
    private Control_trayectoria_irb1090 MoverTrayectoriaScript;
    private Control_trayectoria_irb1090 controlTrayectoriaScript;
    public GameObject trayectoriasObject;

    private Comunicacion_irb1090 comunicacionScript;
    ...
    private TMP_DropdownManager_irb1090 MoverPuntosScript;
    private TMP_DropdownManager_irb1090 controlPuntosScript;
    ...
    private string nombreArchivoprograma = "Programas_irb1090.txt";
    ...
    public void iniciar()
    {
        ...
        if (trayectoriasObject != null)
        {
            MoverTrayectoriaScript = trayectoriasObject.GetComponent<Control_trayectoria_irb1090>();
        ...
        {
            controlPuntosScript = PuntosObject.GetComponent<TMP_DropdownManager_irb1090>();
        ...
        if (PuntosObject != null)
        {
            ...
            MoverPuntosScript = PuntosObject.GetComponent<TMP_DropdownManager_irb1090>();
        ...
        comunicacionScript = comunicacionObject.GetComponent<Comunicacion_irb1090>();

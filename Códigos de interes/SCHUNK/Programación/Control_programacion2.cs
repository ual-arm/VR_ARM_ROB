...
using System.IO;
using static Control_programacion2;

public class Control_programacion2 : MonoBehaviour
{
    ...
    private Control_trayectoria MoverTrayectoriaScript;
    private Control_trayectoria controlTrayectoriaScript;
    public GameObject trayectoriasObject;

    private Comunicacion_irb140 comunicacionScript;
    ...
    private TMP_DropdownManager MoverPuntosScript;
    ...
    private string nombreArchivoprograma = "Programas_irb140.txt";
    ...
    public void iniciar()
    {
        ...
        if (trayectoriasObject != null)
        {
            MoverTrayectoriaScript = trayectoriasObject.GetComponent<Control_trayectoria>();
        ...
        if (PuntosObject != null)
        {
            ...
            MoverPuntosScript = PuntosObject.GetComponent<TMP_DropdownManager>();
       ...
       // borrar_texto = textoObject2.GetComponent<creacion_texto_programa>();
        comunicacionScript = comunicacionObject.GetComponent<Comunicacion_irb140>();
    ...
    public void UpdateSelectedAction()
    {
        ...
        int selectedIndex2 = numeroacciones.value;
        int selectedIndex3 = tipoaccion.value;
        Debug.Log("Condicion: " + selectedIndex);
    ...
    public void LoadPrograma()
    {
        ...
        {
            Debug.LogWarning("El archivo de programas no existe.");
        }
